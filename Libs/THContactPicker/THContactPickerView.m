...
#define kHorizontalPadding      8   // the amount of padding to the left and right of each contact bubble
#define kHorizontalSidePadding  10  // the amount of padding on the left and right of the view
#define kVerticalPadding        11   // amount of padding above and below each contact bubble
...
- (void)setup {
    ...
    self.lineHeight  = 30 +  2 * kVerticalPadding;
...
//    self.placeholderLabel.backgroundColor = [UIColor clearColor];
 //   [self.scrollView addSubview:self.placeholderLabel];
    ...
    self.promptLabel.font = [UIFont fontWithName:FONT_AVENIR_NEXT_MEDIUM size:SIZE_FONT_5];
    self.promptLabel.textColor = WDCOLOR_GRAY_DARK;
    self.promptLabel.text = @"To:";
    self.promptLabel.frame = CGRectMake(11, self.verticalPadding, 30, self.lineHeight);
    [self.scrollView addSubview:self.promptLabel];
    // Create TextView
    self.textView = [[THContactTextField alloc] init];
    self.textView.delegate = self;
    self.textView.font = [UIFont fontWithName:FONT_AVENIR_NEXT_MEDIUM size:SIZE_FONT_5];
    self.textView.autocorrectionType = UITextAutocorrectionTypeNo;
    self.textView.edgeInsets = UIEdgeInsetsMake(2, 0, 0, 0);
    ...
    //default settings
//    self.bubbleStyle = [[THBubbleStyle alloc] initWithTextColor:UICOLOR_WHITE gradientTop:WDCOLOR_BLUE gradientBottom:WDCOLOR_BLUE borderColor:nil borderWidth:0 cornerRadiusFactor:30];
//    self.bubbleSelectedStyle = [[THBubbleStyle alloc] initWithTextColor:UICOLOR_WHITE gradientTop:WDCOLOR_BLUE_LIGHT gradientBottom:WDCOLOR_BLUE borderColor:nil borderWidth:0 cornerRadiusFactor:30];
//    
...
- (void)addContact:(id)contact withName:(NSString *)name {
    ...
    THBubbleStyle *bubbleStyle = [[THBubbleStyle alloc] initWithTextColor:UICOLOR_WHITE gradientTop:WDCOLOR_BLUE gradientBottom:WDCOLOR_BLUE borderColor:nil borderWidth:0 cornerRadiusFactor:2];
    THBubbleStyle *bubbleSelectedStyle = [[THBubbleStyle alloc] initWithTextColor:UICOLOR_WHITE gradientTop:WDCOLOR_BLUE_LIGHT gradientBottom:WDCOLOR_BLUE_LIGHT borderColor:nil borderWidth:0 cornerRadiusFactor:2];
    THContactBubble *contactBubble = [[THContactBubble alloc] initWithName:name style:bubbleStyle selectedStyle:bubbleSelectedStyle showComma:NO];
    [contactBubble setFont:[UIFont fontWithName:FONT_AVENIR_NEXT_MEDIUM size:SIZE_FONT_4]];
